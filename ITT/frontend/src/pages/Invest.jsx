  ...
  const handleConfirmPayment = async () => {
    ...
    try {
      ...
      if (res.data.balance !== undefined) {
        useAuthStore.setState({ user: { ...user, balance: res.data.balance } });
      }

      setPaymentOpen(false);
      setSelectedProduct(null);
      alert(`Successfully invested in ${selectedProduct.name}! Your 32-day investment is now running.`);
